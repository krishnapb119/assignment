    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Text('Login',style: GoogleFonts.almendra(fontWeight: FontWeight.bold,fontSize: 50,color: Colors.cyan),),
            SizedBox(height: 30,),

            Text('Welcome back!Login with your credentials',style: GoogleFonts.amaranth(fontSize: 20,color: Colors.black)),
            SizedBox(height: 50,),
            Padding(
